 ...
 */
 ...
 public class Scrabble {
	...
	public static void testScrabbleScore() {
		System.out.println(wordScore("bee"));	//5
		System.out.println(wordScore("babe"));	//8
		System.out.println(wordScore("friendship"));	//19 + 50 = 69
		System.out.println(wordScore("running"));	//8 + 1000 = 1008
	}
